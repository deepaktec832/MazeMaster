// Web Audio API Sound Generator for retro game audio
...
class SoundSystem {
  ...
  public playPowerUp() {
    ...
    [440, 554.37, 659.25, 880].forEach((freq, idx) => {
      ...
      gain.gain.setValueAtTime(this.volume * 0.2, now + idx * 0.05);
  ...
  public playLose() {
    ...
    notes.forEach((freq, idx) => {
      ...
      gain.gain.setValueAtTime(this.volume * 0.3, now + idx * 0.15);
  ...
  public playGunshot(type: 'pistol' | 'ak47' | 'shotgun' | 'plasma' | 'laser' | 'grenade' | 'rocket' = 'pistol') {
    ...
    if (type === 'ak47') {
      ...
      // Deep heavy booming explosion noise
